pipelineoice(name: 'account', choices: 'development\npipeline\nproduction', description: ''){
    agent {
        node {
      ...
      environment {
        ...
        parameters {
            ...
            string(name: 'partnerName', defaultValue: '', description: '')
            string(name: 'partnerId', defaultValue: '', description: '')
            string(name: 'customerId', defaultValue: '', description: '')
